"""
CaféMind - Multi-Agent AI Coffee Shop Assistant
Guard Agent Module - Security and Query Filtering

This module implements the security layer that filters incoming user queries,
ensuring they are relevant to the coffee shop domain and safe for processing.
